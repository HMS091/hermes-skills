---
name: web-research
description: "Web research for SaaS/platform/service alternatives — 工具选型/评估记录（如 Lightpanda browser 四梯队对比，见 references/lightpanda-browser-evaluation.md） AND deep-dive forum/community crawling — find, compare, and evaluate online services, products, and community knowledge. Covers search engine fallback strategies in restricted environments, proxy-based searching, forum registration/crawling (NodeBB/Discourse/XenForo), Bilibili scraping, cross-region price comparison, and commercial clone-script research."
